    ...
    internal static class Program
    {
        ...
        private static void UnhandledException(object sender, UnhandledExceptionEventArgs ex)
        {
            if (!Debugger.IsAttached)
            {
                ...
                if (MessageBox.Show(text + Environment.NewLine + Environment.NewLine + details, Helper.Assembly.Name, MessageBoxButtons.YesNo, MessageBoxIcon.Error) is DialogResult.Yes)
