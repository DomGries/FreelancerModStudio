...
namespace FreelancerModStudio
{
    partial class frmAbout : Form
    {
		public frmAbout()
		{
			...
			//  - AssemblyInfo.cs
			this.Text = String.Format(Properties.Strings.About, Helper.Assembly.Title);
			this.lblProductName.Text = Helper.Assembly.Product;
			this.lblVersion.Text = String.Format(Properties.Strings.Version, Helper.Assembly.Version.ToString());
